...
describe("DataTable", function () {
    ...
    it("should create a ResultSet", function () {
        ...
        expect(array_keys($response))->toBe(['draw', 'columns', 'recordsTotal', 'recordsFiltered', 'data']);
